...
//                if (TextUtils.isEmpty((CharSequence) edtname) || TextUtils.isEmpty((CharSequence) edtfamily) || TextUtils.isEmpty((CharSequence) edtage)|| TextUtils.isEmpty((CharSequence) edtemail)) {
//                    Toast.makeText(ProfileActivity.this, "fill all part", Toast.LENGTH_LONG).show();
//
//                }
